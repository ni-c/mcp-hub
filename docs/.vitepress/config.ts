...
export default defineConfig({
  ...
  head: [
    ...
    [
      ...
      {
        property: "og:title",
        content: "mcp-hub — one container for all your MCP servers",
      },
    ],
    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: "Releases",
            link: "https://github.com/ni-c/mcp-hub/releases",
          },
          {
            text: "npm package",
            link: "https://www.npmjs.com/package/@ni-c/mcp-hub",
          },
          {
            text: "Container image",
            link: "https://github.com/ni-c/mcp-hub/pkgs/container/mcp-hub",
          },
        ],
      },
    ],
      ...
      "/guide/": [
        {
          ...
          items: [
            ...
            { text: "Servers to run behind it", link: "/guide/servers" },
            {
              text: "Client compatibility",
              link: "/guide/client-compatibility",
            },
          ],
        },
        {
