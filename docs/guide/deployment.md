...
```sh
docker pull ghcr.io/ni-c/mcp-hub:0.4.0
```
...
and pin `ghcr.io/ni-c/mcp-hub:0.4.0@sha256:…`.
...
services:
  mcp-hub:
    image: ghcr.io/ni-c/mcp-hub:0.4.0   # pin a digest in production
...
```dockerfile
FROM ghcr.io/ni-c/mcp-hub:0.4.0
USER root
